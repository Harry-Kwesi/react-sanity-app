...
import { fetchAllPersons, countPersons } from "../redux/actions/personActions";
...
const PersonsListPage = () => {
  ...
  const { loading, error, persons } = useSelector(
    (state) => state.fetchAllPersonsReducer
  );

  return (
    <PersonsListContainer>
      <div className="top">
        <Paginate page={page} setPage={setPage} lastPage={lastPage} />
      </div>
